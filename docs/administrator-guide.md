...
| `tokenhub_gateway_rate_limit_hits_total` | counter | Rejected requests by policy scope and limit type. The optional `key_ref` label is a short hash and never contains the complete API Key. |
