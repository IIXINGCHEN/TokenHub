export const jaTranslations: Record<string, string> = {
    ...
    "查看更新日志": "更新ログを表示",
    "查看版本更新": "バージョン更新を確認",
    "正在检测新版本...": "新しいバージョンを確認中...",
    "版本检测": "バージョン更新",
    "版本检测失败": "バージョン確認に失敗しました",
    "立即更新": "今すぐ更新",
    "重新检测": "再チェック",
    "打开发布页面": "リリースページを開く",
    "当前版本": "現在のバージョン",
    "已是最新版本": "最新バージョンです",
    "最新版本": "最新バージョン",
    "点击立即更新或查看更新日志时打开；留空时使用检测结果里的发布页面。": "「今すぐ更新」または更新ログを表示するときに開きます。空欄の場合はチェック結果のリリースページを使用します。",
    "用于左上角版本提示；支持 GitHub Releases latest/tags API 或返回 latest_version/tag_name 的 JSON 地址。": "左上のバージョン表示で使用します。GitHub Releases latest/tags API、または latest_version/tag_name を返す JSON URL に対応します。",
    ...
    "配置、路由、账号资源与监控指标已合并到同一列表。": "設定、ルート、アカウントリソース、監視指標を1つのリストに統合しました。",
    ...
    "降级/慢响应": "低下 / 遅延応答",
    "综合状态由后端区分配置、主动测试、真实请求与套餐来源。": "総合状態は、設定、アクティブプローブ、実リクエスト、プラン情報からバックエンドが判定します。",
