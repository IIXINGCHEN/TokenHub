export const enTranslations: Record<string, string> = {
    ...
    "更新日志地址": "Release Notes URL",
    "更新检测地址": "Update Check URL",
    "有新版本可用！": "New version available!",
    "查看更新日志": "View release notes",
    "查看版本更新": "Check version updates",
    "正在检测新版本...": "Checking for updates...",
    "版本检测": "Version Updates",
    "版本检测失败": "Version check failed",
    "立即更新": "Update Now",
    "重新检测": "Check Again",
    "打开发布页面": "Open Release Page",
    "当前版本": "Current Version",
    "已是最新版本": "You are up to date",
    "最新版本": "Latest Version",
    "点击立即更新或查看更新日志时打开；留空时使用检测结果里的发布页面。": "Opened by Update Now or View release notes. Leave blank to use the release page returned by the check result.",
    "用于左上角版本提示；支持 GitHub Releases latest/tags API 或返回 latest_version/tag_name 的 JSON 地址。": "Used by the top-left version indicator. Supports the GitHub Releases latest/tags API or a JSON URL returning latest_version/tag_name.",
    ...
    "配置、路由、账号资源与监控指标已合并到同一列表。": "Configuration, routes, account resources, and monitoring metrics are combined in one list.",
    ...
    "综合状态由后端区分配置、主动测试、真实请求与套餐来源。": "The backend derives overall status from configuration, active probes, live requests, and plan data.",
