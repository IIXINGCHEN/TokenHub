export const enTranslations: Record<string, string> = {
    ...
    "安全正则": "Safe Regular Expressions",
    "每行一个正则表达式": "One regular expression per line",
    ...
    "词表与模式至少需要一个关键词或正则表达式": "Keywords and patterns require at least one keyword or regular expression",
