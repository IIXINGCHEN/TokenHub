export const enTranslations: Record<string, string> = {
    ...
    "正在重启": "Restarting",
    "重启失败": "Restart failed",
    "更新命令": "Update commands",
    "将 deploy/.env 中的 TOKENHUB_IMAGE_TAG 固定为目标版本，再执行以下命令。": "Pin TOKENHUB_IMAGE_TAG in deploy/.env to the target version, then run these commands.",
    "复制命令": "Copy commands",
