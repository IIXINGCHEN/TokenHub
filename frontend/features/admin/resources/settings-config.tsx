...
export function systemSettingConfig(): ResourceConfig<AdminResource> {
  const base = genericResourceConfig("settings", "系统设置", "网关地址、审计保留、企业集成和默认策略", [
    ...
    { key: "version_update_url", label: "更新检测地址", placeholder: "https://api.github.com/repos/astaxie/TokenHub/releases/latest", help: "用于左上角版本提示；支持 GitHub Releases latest API 或返回 latest_version/tag_name 的 JSON 地址。" },
